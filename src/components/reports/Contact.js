  ...
  const Contact = ({invoice}) => (
    <View style={styles.container}>
      ...
      <View  style={[styles.subContainer,{width:'52%'}]}>
        <Image style={styles.logo} src="https://img.icons8.com/external-kmg-design-glyph-kmg-design/32/undefined/external-map-back-to-school-kmg-design-glyph-kmg-design.png" />
